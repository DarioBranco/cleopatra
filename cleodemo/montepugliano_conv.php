...
<head>
	...
	<script type='text/javascript' src='chung/chatbot_chung_prog.js'></script>
  ...
  <script type="text/javascript" src="chung/chatbot_chung_say.js"></script>
     ...
     <link rel="stylesheet" type="text/css" media="screen" href="package704/dist/converse.min.css">
     <script src="package704/dist/converse.js"></script>
...
<script>
		...
		var aut = converse.initialize({
			...
			auto_login: true,
			allow_logout: false,
			auto_join_rooms: [{'jid': 'chat@muc.cleopatra-agents.cloud'}]
		});
	...
	var miradorInstance = Mirador.viewer({
      ...
      manifestId: 'montepugliano/index.json',
