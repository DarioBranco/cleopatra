...
29 March 2021 - Version 2.6.1
	NEW! Instagram Widget
	UPDATED! Revolution Slider Plugin
	UPDATED! Vestige Core Plugin
	FIXED! Revolution Slider not working for some users

09 February 2021 - Version 2.6
	IMPROVED! Mobile Menu
	UPDATED! Revolution Slider Plugin
	UPDATED! Vestige Core Plugin
	FIXED! Pagination discrepencies in artwork single pages
	FIXED! Event registration form not getting redirected to PayPal

21 August 2020 - Version 2.5.1
	UPDATED! Revolution Slider Plugin
	FIXED! Upload taxonomy image not working

14 August 2020 - Version 2.5
	UPDATED! Compatibility with WP version 5.5
	UPDATED! Revolution Slider Plugin

29 July 2020 - Version 2.4.2
	FIXED! A problem with the past events category filteration
	FIXED! Sidebar is always visible on single post pages

17 July 2020 - Version 2.4.1
    UPDATED! Revolution Slider Plugin
	FIXED! Unwanted space above header
	FIXED! Some styling issues

09 June 2020 - Version 2.4
	...
	FIXED! Event/Exhibition single pages shows blank whhen print
...
21 February 2020 - Version 2.3
    UPDATED! Vestige Core Plugin
    UPDATED! Revolution Slider Plugin
    UPDATED! Venue ID guide in venue list/grid page builder widget
