...
/* * ** Meta Box Functions **** */
$meta_boxes = array();
function vestige_register_meta_boxes($meta_boxes)
{
	$prefix = 'imic_';
	global $meta_boxes;
	/* Staff Meta Box
	...
	$meta_boxes[] = array(
		...
		'fields' => array( 		 
			...
			array(
				'name' => esc_html__('Custom Details', 'vestige'),
				'id' => $prefix . 'event_details_custom_details',
				'desc' => esc_html__("Add additional details for the details tab on single page.", 'vestige'),
				'type' => 'wysiwyg',
				'std' => '',
				'visible' => array('imic_event_details_data','=','1')
			),
			array(
...
add_action('rwmb_meta_boxes', 'vestige_register_meta_boxes');
/* * ******************* META BOX CHECK ********************** */
/**
