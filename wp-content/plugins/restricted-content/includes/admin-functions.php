      ...
      function rsc_generate_admin_box_content($field_name, $default_value = '') {
        ...
        switch ($field_name) {
          ...
          case 'content_availability_specific_role':
                    ...
                    <label>
                        ...
                        <select id="rsc_woo_limited_time_days">
                            ...
                            for ($day = apply_filters('rsc_woo_time_day_min', 0); $day <= apply_filters('rsc_woo_time_day_max', 365); $day++) {
                                ?>
                                <option value="<?php echo esc_attr($day); ?>"><?php echo $day; ?></option>
                                <?php
                            }
                            ?>
                        </select>
                    ...
                    <label>
                        ...
                        <select id="rsc_woo_limited_time_hours">
                            ...
                            for ($hour = apply_filters('rsc_woo_time_hour_min', 0); $hour <= apply_filters('rsc_woo_time_hour_max', 24); $hour++) {
                                ?>
                                <option value="<?php echo esc_attr($hour); ?>"><?php echo $hour; ?></option>
                                <?php
                            }
                            ?>
                        </select>
                    ...
                    <label>
                        ...
                        <select id="rsc_woo_limited_time_minutes">
                            ...
                            for ($minute = apply_filters('rsc_woo_time_minute_min', 0); $minute <= apply_filters('rsc_woo_time_minute_', 60); $minute++) {
                                ?>
                                <option value="<?php echo esc_attr($minute); ?>"><?php echo $minute; ?></option>
                                <?php
                            }
                            ?>
                        </select>
            ...
            <?php
            $default_value = esc_attr('[rsc_restrict_content allowed_to="edd" edd_options="product" edd_product="0"]'.rsc_get_default_admin_shortcode_message().'[/rsc_restrict_content]');
            ?>
