                        ...
                        switch ( $rsc_edd_users ) {
                            case 'anything':
                                ...
                                if ( $can_access ) {
                                    ...
                                    $message = Restricted_Content::rsc_get_message( $type . '_' . $rsc_edd_users );
                                }
                    ...
                    switch ( $rsc_woo_users ) {
                        ...
                        case 'product':
                            ...
                            if ( empty($rsc_woo_users_time) || !isset( $rsc_woo_users_time ) || $rsc_woo_users_time == 'indefinitely' ) {
                                ...
                                if ( Restricted_Content::has_limited_woo_purchases( get_current_user_id(), $products_ids, $time ) ) {
                                    return true;
                                } else {
                                    return false;
                                }
                    ...
                    switch ( $rsc_edd_users ) {
                        ...
                        case 'product':
                            ...
                            if ( empty($rsc_edd_users_time) || !isset( $rsc_edd_users_time ) || $rsc_edd_users_time == 'indefinitely' ) {
                                ...
                                if ( Restricted_Content::rsc_edd_has_user_purchased( get_current_user_id(), $products_ids, $time ) ) {
                                    return true;
                                } else {
                                    return false;
                                }
      ...
      <?php 
        ...
        <div class="rsc_sub_sub rsc_woo_product rsc_sub_hide rsc_sub_sub_metabox_product">
          ...
          <label><?php 
                    ...
                    ?></label>
          <input type="radio" name="<?php 
                    echo  Restricted_Content::get_field_name( '_rsc_woo_users_time_rsc_post_meta', $widget, $widget_instance ) ;
          ...
          <div class="rsc_woo_times">
            <label>
              <?php 
                    ...
                    ?><br />
              <select name="<?php 
                    echo  Restricted_Content::get_field_name( '_rsc_woo_users_time_days_rsc_post_meta', $widget, $widget_instance ) ;
                    ?>">
                <?php 
            ...
            <label>
              <?php 
                    ...
                    ?><br />
              <select name="<?php 
                    echo  Restricted_Content::get_field_name( '_rsc_woo_users_time_hours_rsc_post_meta', $widget, $widget_instance ) ;
                    ?>">
                <?php 
            ...
            <label>
              <?php 
                    ...
                    ?><br />
              <select name="<?php 
                    echo  Restricted_Content::get_field_name( '_rsc_woo_users_time_minutes_rsc_post_meta', $widget, $widget_instance ) ;
                    ?>">
                <?php 
        ...
        <label><?php 
                    ...
                    ?></label>
        <input type="radio" name="<?php 
                    echo  Restricted_Content::get_field_name( '_rsc_edd_users_rsc_post_meta', $widget, $widget_instance ) ;
        ...
        <div class="rsc_sub_sub rsc_edd_product rsc_sub_hide rsc_sub_sub_metabox_product">
          <select name="<?php 
                    echo  Restricted_Content::get_field_name( '_rsc_edd_users_product_rsc_post_meta[]', $widget, $widget_instance ) ;
                    ?>" multiple>
            <?php 
          ...
          <label><?php 
                    ...
                    ?></label>
          <input type="radio" name="<?php 
                    echo  Restricted_Content::get_field_name( '_rsc_edd_users_time_rsc_post_meta', $widget, $widget_instance ) ;
          ...
          <div class="rsc_edd_times">
            <label>
              <?php 
                    ...
                    ?><br />
              <select name="<?php 
                    echo  Restricted_Content::get_field_name( '_rsc_edd_users_time_days_rsc_post_meta', $widget, $widget_instance ) ;
                    ?>">
                <?php 
            ...
            <label>
              <?php 
                    ...
                    ?><br />
              <select name="<?php 
                    echo  Restricted_Content::get_field_name( '_rsc_edd_users_time_hours_rsc_post_meta', $widget, $widget_instance ) ;
                    ?>">
                <?php 
            ...
            <label>
              <?php 
                    ...
                    ?><br />
              <select name="<?php 
                    echo  Restricted_Content::get_field_name( '_rsc_edd_users_time_minutes_rsc_post_meta', $widget, $widget_instance ) ;
                    ?>">
                <?php 
